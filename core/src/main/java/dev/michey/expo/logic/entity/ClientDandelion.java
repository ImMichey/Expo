...
public class ClientDandelion extends ClientEntity implements SelectableEntity {
    ...
    public void renderSelected(RenderContext rc, float delta) {
        ...
        rc.arraySpriteBatch.drawCustomVertices(dandelion, clientPosX, clientPosY, dandelion.getWidth(), dandelion.getHeight(), wind + verticesMovement, wind + verticesMovement);
    ...
    public void renderShadow(RenderContext rc, float delta) {
        ...
        if(drawGrass) {
            rc.useArrayBatch();
            rc.useRegularArrayShader();
            rc.arraySpriteBatch.drawGradientCustomVertices(this.shadow, this.shadow.getRegionWidth(), this.shadow.getRegionHeight(), shadow, wind + verticesMovement, wind + verticesMovement);
        }
    }
