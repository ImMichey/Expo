 ...
 * @author Nathan Sweet */
public class PolygonTileBatch implements PolygonBatch {
    private Mesh mesh;
     ...
     * @see #PolygonTileBatch(int, int, ShaderProgram) */
    public PolygonTileBatch () {
        this(2000, null);
    }
     ...
     * @see #PolygonTileBatch(int, int, ShaderProgram) */
    public PolygonTileBatch (int size) {
     ...
     * @param size The max number of vertices and number of triangles in a single batch. Max of 32767.
     * @see #PolygonTileBatch(int, int, ShaderProgram) */
    public PolygonTileBatch (int size, ShaderProgram defaultShader) {
    ...
    public PolygonTileBatch (int maxVertices, int maxTriangles, ShaderProgram defaultShader) {
